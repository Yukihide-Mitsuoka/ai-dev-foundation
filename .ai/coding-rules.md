...
## id: coding-rules title: Coding Rules authority: 4 read_when: [feature, bugfix, refactor, review]
...
1. Check: license compatible (see REL-030)? maintained (release within ~12 months)?
   reasonable transitive footprint? known CVEs?
1. Record purpose + alternatives in the PR description (GR-023).
