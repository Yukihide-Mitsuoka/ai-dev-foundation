...
## id: security title: Security Policy (AI-facing) authority: 2 read_when: [always-summary, security, review, release]
...
1. Do not push, do not open a public issue/PR describing the vulnerability.
1. If a secret leaked into any commit (even unpushed): consider it compromised —
   report to the human immediately for rotation; removing the commit is not enough.
1. Report privately: GitHub Security Advisory (see `/SECURITY.md`).
1. Record remediation in the decision log after resolution.
