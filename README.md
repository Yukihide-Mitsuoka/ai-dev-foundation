...
| Task playbooks | [`.skills/`](.skills/) | 9 vendor-neutral skills: feature, bugfix, refactor, architecture, test, security, documentation, review, release |
| Enforcement L1 | [`.claude/`](.claude/) | Claude Code hooks: command guard + auto format/lint |
