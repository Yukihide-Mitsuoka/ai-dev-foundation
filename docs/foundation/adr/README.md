...
| [0016](0016-gate-private-fleet-automation-on-split-credentials.md) | Gate private fleet automation on split credentials | private repositories, template inheritance, fleet audit, credentials | proposed | 2026-08-09 |
