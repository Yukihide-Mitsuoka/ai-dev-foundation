...
| [0022](0022-integrate-documented-discovery-and-conditional-tdd.md) | Integrate documented discovery and conditional TDD into existing task routes | requirements, architecture, domain terminology, testing, AI workflow | proposed | 2026-09-13 |
